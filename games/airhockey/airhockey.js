$(document).ready(function() {
    ...
    if ($(window).height() <= 320) {
        ...
        balltop = 132;
        screensize = 0
    } else if ($(window).width() > 1100) { margtop2reset = 310;
        margtop1reset = 310;
        ballleftreset = 610;
        balltopreset = 332;
        margleft1reset = 180;
        ...
        bottomline = 553;
        screensize = 2 }
    striker2.style.top = margtop2;
    striker1.style.top = margtop1;
    ballel.style.left = ballleft;
    ballel.style.top = balltop;
    striker1.style.left = margleft1;
    striker2.style.left = margleft2;
    var ballright = ballleft + 50;
    var right1 = margleft1 + strikerwidth
    ...
    var time = 30;
    var flag = 0;
    var map = { 87: !1, 83: !1, 38: !1, 40: !1, 13: !1, 82: !1 };
    ...
    function getallvalues() { margtop2 = striker2.style.top;
        margtop2 = margtop2.replace("px", " ");
        margtop2 = parseInt(margtop2);
        margtop1 = striker1.style.top;
        margtop1 = margtop1.replace("px", " ");
    ...
    function leftStrikerUpFunc() {
        ...
        getallvalues();
        if (screensize == 2) {
            if (margtop1 > topline) { striker1.style.top = (margtop1 - 20) + "px" } else {
                if (leftupid)
                    clearInterval(leftupid)
            }
        } else if (screensize == 0) {
            if (margtop1 > topline + 6) { striker1.style.top = (margtop1 - 20) + "px" } else {
                if (leftupid)
                    clearInterval(leftupid)
            }
        }
    ...
    function leftStrikerDownFunc() {
        ...
        if (screensize == 2) {
            if (lengthstrikers == 50 || lengthstrikers == 70) {
                if (bottom1 < bottomline) { striker1.style.top = (margtop1 + 20) + "px" } else {
                    if (leftdownid)
                        clearInterval(leftdownid)
                }
            } else if (lengthstrikers == 90) {
                if (bottom1 < bottomline - 1) { striker1.style.top = (margtop1 + 20) + "px" } else {
                    if (leftdownid)
                        clearInterval(leftdownid)
                }
            }
            ...
            if (lengthstrikers == 50 || lengthstrikers == 70) {
                if (bottom1 < bottomline - 14) { striker1.style.top = (margtop1 + 20) + "px" } else {
                    if (leftdownid)
                        clearInterval(leftdownid)
                }
            } else if (lengthstrikers == 90) {
    ...
    function rightStrikerUpGenerator() { rightupid = setInterval(rightStrikerUpFunc, 50) }
    ...
    function rightStrikerUpFunc() {
        getallvalues();
        if (screensize == 2) {
            if (margtop2 > topline) { striker2.style.top = (margtop2 - 20) + "px" } else {
                if (rightupid)
                    clearInterval(rightupid)
            }
        } else if (screensize == 0) {
            if (margtop2 > topline + 6) { striker2.style.top = (margtop2 - 20) + "px" } else {
                if (rightupid)
                    clearInterval(rightupid)
            }
        }
    ...
    function rightStrikerDownGenerator() { rightdownid = setInterval(rightStrikerDownFunc, 50) }
    ...
    function rightStrikerDownFunc() {
        ...
        if (screensize == 2) {
            if (lengthstrikers == 50 || lengthstrikers == 70) {
                if (bottom2 < bottomline) { striker2.style.top = (margtop2 + 20) + "px" } else {
                    if (rightdownid)
                        clearInterval(rightdownid)
                }
            } else if (lengthstrikers == 90) {
                if (bottom2 < bottomline - 1) { striker2.style.top = (margtop2 + 20) + "px" } else {
                    if (rightdownid)
                        clearInterval(rightdownid)
                }
            }
            ...
            if (lengthstrikers == 50 || lengthstrikers == 70) {
                if (bottom2 < bottomline - 14) { striker2.style.top = (margtop2 + 20) + "px" } else {
                    if (rightdownid)
                        clearInterval(rightdownid)
                }
            } else if (lengthstrikers == 90) {
    ...
    function positionagain() { ballel.style.left = ballleftreset;
        ballel.style.top = balltopreset;
        striker2.style.top = margtop2reset;
        striker1.style.top = margtop1reset;
        striker1.style.left = margleft1reset;
        striker2.style.left = margleft2reset;
        getallvalues();
        flag = 0 }

    function amatuerfunc() { amatuer.style.backgroundColor = "yellow";
        ninja.style.backgroundColor = "transparent";
        pro.style.backgroundColor = "transparent";
        positionagain();
        lengthstrikers = 90;
        striker1.style.height = lengthstrikers;
        striker2.style.height = lengthstrikers;
        getallvalues();
        clearInterval(id) }

    function profunc() { pro.style.backgroundColor = "yellow";
    ...
    function ninjafunc() { ninja.style.backgroundColor = "yellow";
        pro.style.backgroundColor = "transparent";
        amatuer.style.backgroundColor = "transparent";
        positionagain();
        lengthstrikers = 50;
    ...
    function slowfunc() { medium.style.backgroundColor = "transparent";
    ...
    function mediumfunc() { slow.style.backgroundColor = "transparent";
        fast.style.backgroundColor = "transparent";
    ...
    function fastfunc() { slow.style.backgroundColor = "transparent";
    ...
    function beginfunc() {
        if (flag == 0) {
            ...
            flag = 1;
            if (random == 0) { y = 10;
                x = 10 } else if (random == 1) { y = -10;
                x = 10 } else if (random == 2) { y = 10;
                x = -10 } else if (random == 3) { y = -10;
                x = -10 }
    ...
    function func(event) {
        ...
        getallvalues();
        if (event.keyCode in map) { map[event.keyCode] = !0 }
        if (map[40] == !0 && map[38] == !1) {
            rightStrikerDownFunc();
            if (map[87] == !0 && map[83] == !1) { leftStrikerUpFunc() } else if (map[83] == !0 && map[87] == !1) { leftStrikerDownFunc() }
        }
        ...
        if (map[87] == !0 && map[83] == !1) {
            leftStrikerUpFunc();
            if (map[38] == !0 && map[40] == !1) { rightStrikerUpFunc() } else if (map[40] == !0 && map[38] == !1) { rightStrikerDownFunc() }
        }
        if (map[83] == !0 && map[87] == !1) {
            leftStrikerDownFunc();
            if (map[38] == !0 && map[40] == !1) { rightStrikerUpFunc() } else if (map[40] == !0 && map[38] == !1) { rightStrikerDownFunc() }
        } else if (map[13] == !0 && flag === 0) { beginfunc() } else if (map[82] == !0) { resetfunc() }
    }
    ...
    function move() {
        getallvalues();
        if (ballbottom > (bottomline) || balltop < (topline + 10)) { y = -y }
        if (ballright > margleft2 + 15) {
            if (collisionRight() == !0) {
                ...
                score1el.innerHTML = scoreplayer1;
                score2el.innerHTML = scoreplayer2;
                if (scoreplayer1 == 50) { alert("PLAYER1 WINS!");
                    resetfunc() }
        ...
        if (ballleft < right1 - 15) {
            if (collisionLeft() == !0) {
                ...
                score1el.innerHTML = scoreplayer1;
                score2el.innerHTML = scoreplayer2;
                if (scoreplayer2 == 50) { alert("PLAYER2 WINS!");
                    resetfunc() }
    ...
    function resetfunc() { positionagain();
        clearInterval(id);
        scoreplayer1 = 0;
        scoreplayer2 = 0;
        score1el.innerHTML = scoreplayer1;
